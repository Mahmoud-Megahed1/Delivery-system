                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.properties.store") }}" enctype="multipart/form-data">
                        ...
                        <div style="display:none" class="form-group {{ $errors->has('bedrooms') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="bedrooms" id="bedrooms" value="{{ old('bedrooms', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('beds') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="beds" id="beds" value="{{ old('beds', '') }}" step="1">
                            @if($errors->has('beds'))
                        ...
                        <div class="form-group {{ $errors->has('bathroom') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="bathroom" id="bathroom" value="{{ old('bathroom', '') }}" step="1">
                        ...
                        <div style="display:none" class="form-group {{ $errors->has('bed_type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="bed_type_id" id="bed_type_id">
                                @foreach($bed_types as $id => $entry)
                                    <option value="{{ $id }}" {{ old('bed_type_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('property_sqft') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="property_sqft" id="property_sqft" value="{{ old('property_sqft', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('amenities') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control multipleaddselect select2" name="amenities_id[]" id="amenities_id" multiple>
                                @foreach($amenities as $id => $entry)
                                    <option value="{{ $id }}" {{ old('amenities_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div style="display:none" class="form-group {{ $errors->has('property_rating') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="property_rating" id="property_rating" value="{{ old('property_rating', '') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('person_allowed') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="person_allowed" id="person_allowed" value="{{ old('person_allowed', '') }}" step="1">
                        ...
                        <div style="display:none" class="form-group {{ $errors->has('accommodates') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="accommodates" id="accommodates" value="{{ old('accommodates', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('state_region') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="state_region" id="state_region" value="{{ old('state_region', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('zip_postal_code') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="zip_postal_code" id="zip_postal_code" value="{{ old('zip_postal_code', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('longtitude') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="longtitude" id="longtitude" value="{{ old('longtitude', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('is_verified') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="is_verified" id="is_verified">
                                ...
                                @foreach(App\Models\Property::IS_VERIFIED_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('is_verified', '0') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('is_featured') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="is_featured" id="is_featured">
                                ...
                                @foreach(App\Models\Property::IS_FEATURED_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('is_featured', '0') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('weekly_discount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="weekly_discount" id="weekly_discount" value="{{ old('weekly_discount', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('weekly_discount_type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="weekly_discount_type" id="weekly_discount_type">
                                ...
                                @foreach(App\Models\Property::WEEKLY_DISCOUNT_TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('weekly_discount_type', 'percent') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('monthly_discount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="monthly_discount" id="monthly_discount" value="{{ old('monthly_discount', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('monthly_discount_type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="monthly_discount_type" id="monthly_discount_type">
                                ...
                                @foreach(App\Models\Property::MONTHLY_DISCOUNT_TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('monthly_discount_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
...
<script>
    ...
    $(document).ready(function() {
        ...
        const selectedAmenities = {!! json_encode(old('amenities_id', [])) !!};
