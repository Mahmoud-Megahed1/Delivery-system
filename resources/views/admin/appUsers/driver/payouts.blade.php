                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        ...
                        <select class="form-control select2" name="status" id="status">
                            ...
                            <option value="Success" {{ request()->input('status') === 'Success' ? 'selected' : ''
                                }}>Success</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-4 mt-5 ">
                        ...
                        <button type="button" name="resetBtn" id="resetBtn"
                            class="btn btn-primary btn-flat resetproduct">{{ trans('global.reset') }}</button>
                    </div>
                ...
                <div class="table-responsive">
                            ...
                            <tr data-entry-id="{{ $payout->id }}">
                                ...
                                <td>
                                    ...
                                    <a style="margin-bottom:5px;margin-top:5px" class="btn btn-xs btn-info"
                                        href="{{ route('admin.payouts.edit', $payout->id) }}">
                    ...
                    <nav aria-label="...">
                        <ul class="pagination justify-content-end">
                            ...
                            <li class="page-item">
                                <a class="page-link" href="{{ $payouts->previousPageUrl() }}" tabindex="-1"> {{
                            ...
                            @for ($i = 1; $i <= $payouts->lastPage(); $i++)
                                ...
                                <li class="page-item">
                                    <a class="page-link" href="{{ $payouts->nextPageUrl() }}"> {{ trans('global.next')
                                        }}</a>
                                </li>
                                @else
                                <li class="page-item disabled">
