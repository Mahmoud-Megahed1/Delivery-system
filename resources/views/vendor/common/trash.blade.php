...
<div class="content">
    ...
    <form id="deleteAllForm" action="{{ route('vendor.common.trash.permanentDeleteAll') }}" method="POST" style="display: inline-block;">
    @csrf
                            ...
                            <tbody>
                                @foreach($items as  $item)
                                    ...
                                    <td></td>
                                        ...
                                        <td>
                                            <form id="restore-form-{{ $item->id }}" action="{{ route('vendor.common.trash.restore', $item->id) }}" method="POST" style="display: inline-block;">
                                                @csrf
...
$(function () {
    ...
    function handleDeletion(route) {
        ...
        let deleteRoute = "{{ route('vendor.trash-delete.rows') }}";
