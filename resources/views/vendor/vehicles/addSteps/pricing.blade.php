                ...
                <div class="row ">
                  <div class="mt-4 col-lg-12 col-md-12">
                    <div class="col-6  col-lg-6  text-left">
                      <a data-prevent-default="" href="{{route('vendor.vehicles.photos',[$id])}}" class="btn btn-large btn-primary f-14">{{trans('global.back')}}</a>
                    </div>
    ...
    $('.nextStep').click(function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          $('.error-message').text('');
          window.location.href = '/vendor/vehicles/cancellation-policies/' + id;
        },
