      ...
      children: [
        ...
        Positioned(
          ...
          child: Text(
            ...
            style: headingBlackBold(context).copyWith(fontSize: 15),
            semanticsLabel:
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: headingBlack(context).copyWith(fontSize: 12),
                  softWrap: true,
                  maxLines: 2,
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: headingBlackBold(context).copyWith(fontSize: 16),
